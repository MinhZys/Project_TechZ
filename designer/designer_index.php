...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/userHeadr.css">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto"> <!-- ms-auto aligns items to the right -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="servicesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">BLOG</a>
                        <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
                            <li><a class="dropdown-item" href="../designer/blog.php">Mới Nhất</a></li>
                        </ul>
                    </li>
                   
                    
                    <li class="nav-item">
                        <a class="nav-link" href="#">Thông báo<span style="color:orange;">🔥</span></a>
                    </li>
    ...
    <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../assets/images/LA.jpg" alt="Los Angeles" class="d-block w-100">
            ...
            <div class="carousel-item active">
                <img src="../assets/images/chicago.jpg" alt="Chicago" class="d-block w-100">
                <div class="carousel-caption d-none d-md-block">
                    <h3>Chicago</h3>
            ...
            <div class="carousel-item">
                <img src="../assets/images/pexels-fotoaibe-1571457.jpg" alt="New York" class="d-block w-100">
                <div class="carousel-caption d-none d-md-block">
                    <h3>New York</h3>
